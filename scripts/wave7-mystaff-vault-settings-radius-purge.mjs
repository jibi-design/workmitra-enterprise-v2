/**
 * Wave 7a — MyStaff + Vault + Settings radius purge
...
const roots = [
  "src/features/employer/myStaff",
  "src/features/employer/workVault",
  "src/features/employee/workVault",
  "src/features/employee/settings",
