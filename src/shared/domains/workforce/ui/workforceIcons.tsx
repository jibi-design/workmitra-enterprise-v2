...
export function IconAnnounce() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="currentColor"
        d="M18 11v2h4v-2h-4Zm-2 6.61c.96.71 2.21 1.65 3.2 2.39.49-.67 1-1.32 1.49-1.99-.99-.74-2.24-1.68-3.2-2.4-.49.67-1 1.33-1.49 2Zm4.8-14.01c-.49-.66-1-1.32-1.49-1.99-.99.74-2.24 1.68-3.2 2.4.49.66 1 1.32 1.49 1.99.96-.72 2.21-1.66 3.2-2.4ZM8 9H4c-1.1 0-2 .9-2 2v2c0 1.1.9 2 2 2h1l5 3V6L5 9h3Zm5.5 3c0-1.33-.58-2.53-1.5-3.35v6.69c.92-.81 1.5-2.01 1.5-3.34Z"
      />
    </svg>
  );
}
