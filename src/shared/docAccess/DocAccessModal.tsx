  ...
  return (
    <div>
      ...
      <button
        type="button"
        onClick={() => {
          if (isFilled) onSubmit(digits.join(""));
        }}
        disabled={!isFilled}
        style={{
          width: "100%",
      ...
      >
        {step === "requesting" && (
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            ...
            <div style={{ fontSize: 12, color: "var(--wm-er-muted)", lineHeight: 1.6 }}>
              An OTP has been sent to <strong>{workerName}</strong>'s app. Ask them to share the 6-digit code with
              you.
            </div>
          </div>
        )}
          ...
          <>
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ fontSize: 12, color: "var(--wm-er-muted)", lineHeight: 1.5 }}>
                Ask <strong>{workerName}</strong> to share the 6-digit OTP from their Job Mitra app. Code expires in 5
                minutes.
              </div>
            </div>
            ...
            >
              The employee must approve. They will see a notification with the OTP. Only proceed if they confirm.
            </div>
        ...
        {step === "viewing" && !sessionActive && (
          <div style={{ textAlign: "center", padding: 20 }}>
            <div style={{ fontSize: 15, fontWeight: 700, color: "#dc2626", marginBottom: 6 }}>Session Expired</div>
