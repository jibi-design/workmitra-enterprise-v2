...
const CONFIG: Record<HRCandidateStatus, EmptyConfig> = {
  ...
  offered: {
    ...
    description: "Send an offer letter from the Pending tab to move candidates here.",
    iconColor: "#7c3aed",
  ...
  exit_processing: {
    ...
    iconBg: "rgba(220, 38, 38, 0.08)",
    iconPath:
      "M10.79 16.29c.39.39 1.02.39 1.41 0l3.59-3.59a.996.996 0 000-1.41L12.2 7.7a.996.996 0 10-1.41 1.41L12.67 11H4c-.55 0-1 .45-1 1s.45 1 1 1h8.67l-1.88 1.88c-.39.39-.38 1.03 0 1.41zM19 3H5c-1.11 0-2 .9-2 2v3c0 .55.45 1 1 1s1-.45 1-1V5h14v14H5v-3c0-.55-.45-1-1-1s-1 .45-1 1v3c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z",
  },
  exited: {
    title: "No exited employees",
    description: "Completed exit records will appear here after finalization.",
    iconColor: "#16a34a",
    iconBg: "rgba(22, 163, 74, 0.08)",
    iconPath:
      "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z",
