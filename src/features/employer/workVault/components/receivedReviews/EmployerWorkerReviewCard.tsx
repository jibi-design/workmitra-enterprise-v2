// App name: Job Mitra
// File name: EmployerWorkerReviewCard.tsx
// Full file path: C:\projects\WorkMitra_Enterprise_v2\src\features\employer\workVault\components\receivedReviews\EmployerWorkerReviewCard.tsx

import type { EmployerWorkerReviewRecord } from "../../types/employerVaultReview.types";
import { formatEmployerVaultDate } from "../../helpers/employerVaultReviewHelpers";

type EmployerWorkerReviewCardProps = {
  record: EmployerWorkerReviewRecord;
  onOpenWorkspace?: (workspaceId: string) => void;
};

const SHIFT_GREEN = "#16a34a";

export function EmployerWorkerReviewCard({
  record,
  onOpenWorkspace,
}: EmployerWorkerReviewCardProps) {
  return (
    <article
      style={{
        padding: 15,
    ...
    >
      ...
      >
        ...
        >
          Would work again: {record.workAgain ? "Yes" : "No"} ·{" "}
