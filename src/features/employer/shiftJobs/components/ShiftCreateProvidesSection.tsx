...
function IconProvide() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="currentColor"
        d="M20 6h-2.18c.07-.44.18-.9.18-1.36 0-2.57-2.09-4.64-4.64-4.64C11.8.0 10.58.93 9.9 2.2L8 5H4C2.9 5 2 5.9 2 7v13c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-6-4c1.47 0 2.64 1.17 2.64 2.64 0 .56-.17 1.04-.45 1.36H9.09L10.6 3.4C11.05 2.57 11.97 2 13.0 2zm7 18H4V7h16v13z"
      />
    </svg>
  );
}
    ...
    <section className="wm-er-card" style={{ marginTop: 12 }}>
            ...
            {suggested.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  {isOn && (
                    <span
                      style={{ fontSize: 11, fontWeight: 700, color: "var(--wm-er-accent-shift)" }}
                    >
                      &#10003;
                    </span>
                  )}
      ...
      {selected.length > 0 && (
        <div style={{ marginTop: 10, fontSize: 11, color: "var(--wm-er-muted)" }}>
          {selected.length} item{selected.length !== 1 ? "s" : ""} selected &mdash; workers will see
          this on the shift details page.
        </div>
      )}
    </section>
  );
