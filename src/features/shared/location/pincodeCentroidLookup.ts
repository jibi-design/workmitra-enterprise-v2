/** Job Mitra | Static pincode centroid lookup (town first, then 3-digit district). */

import { parsePincode } from "./pincode";
import { PINCODE_DISTRICT_CENTROIDS } from "./pincodeDistrictCentroids";
import { PINCODE_TOWN_CENTROIDS } from "./pincodeTownCentroids";
