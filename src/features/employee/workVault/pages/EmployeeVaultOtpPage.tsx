...
export function EmployeeVaultOtpPage() {
  ...
  function handleGenerate() {
    ...
    if (!result.ok) {
      setNotice({
        title: "Storage Error",
        message: "Could not save the access code. Free up browser storage and try again.",
        tone: "error",
      });
      return;
    }
      ...
      >
        {otp ? (
          ...
          <div style={{ textAlign: "center" }}>
            ...
            >
              Generate a 6-digit code to share with an employer. The code expires after 5 minutes
