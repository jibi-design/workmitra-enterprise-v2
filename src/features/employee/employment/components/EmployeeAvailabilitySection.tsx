...
export function EmployeeAvailabilitySection({ hrCandidateId }: Props) {
  ...
  const selectedRequest = selectedId ? staffAvailabilityStorage.getById(selectedId) : null;
