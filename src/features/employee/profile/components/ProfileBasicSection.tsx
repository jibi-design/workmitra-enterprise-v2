    ...
    <section className="wm-profileSectionCard" style={{ marginTop: 12 }} ref={sectionRef}>
      ...
      <div className="wm-field">
        <label className="wm-label">
          Full name <span style={{ color: "var(--wm-error)" }}>*</span>
        </label>
        <input
          className="wm-input"
          ...
          onBlur={() =>
            onUpdate("fullName", clampString(draft.fullName.trim().replace(/\s+/g, " "), 60))
          }
      ...
      <div className="wm-field" style={{ marginTop: 10 }}>
        <label className="wm-label">
          City <span style={{ color: "var(--wm-error)" }}>*</span>
        </label>
        <input
          className="wm-input"
          value={draft.city}
