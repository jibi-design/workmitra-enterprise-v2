-- Sprint 3 — paste into Supabase SQL Editor (platform_ops)
-- Prefer running after auth tables exist.
-- Note: run sprint1_auth_rls_revoke.sql first (separate query). Do not use psql \i here.
